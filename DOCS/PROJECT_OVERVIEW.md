...
- Explication optionnelle via Gemini, sans modifier le verdict.
...
9. Le serveur genere une explication prudente avec Gemini si la cle est configuree, sinon avec un fallback local.
...
Le verdict de securite vient du moteur de regles local. Gemini est utilise uniquement pour expliquer un verdict deja decide.
