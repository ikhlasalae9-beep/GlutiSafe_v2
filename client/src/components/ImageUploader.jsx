    ...
    <div className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
      {isCamera ? (
        <div className="group flex min-h-[280px] flex-col items-center justify-center rounded-[1.5rem] border-2 border-dashed border-[#a8cfa5] bg-[#f7f8f6] p-6 text-center transition hover:border-[#008f45] hover:bg-white">
          ...
          <h3 className="mt-5 text-xl font-extrabold text-[#1d252b]">Ouvrir la caméra</h3>
          <p className="mt-2 max-w-sm text-sm leading-6 text-slate-600">
            Utilisez la caméra réelle de l'appareil pour cadrer la liste complète des ingrédients.
          </p>
        ...
        <label className="group flex min-h-[280px] cursor-pointer flex-col items-center justify-center rounded-[1.5rem] border-2 border-dashed border-[#a8cfa5] bg-[#f7f8f6] p-6 text-center transition hover:border-[#008f45] hover:bg-white focus-within:ring-4 focus-within:ring-[#a8cfa5]/35">
          ...
          <span className="mt-5 text-xl font-extrabold text-[#1d252b]">Importer une étiquette</span>
          <span className="mt-2 max-w-sm text-sm leading-6 text-slate-600">
            Utilisez une image nette avec la liste complète des ingrédients. JPG, PNG ou photo mobile.
          </span>
      ...
      <div className="soft-card p-4">
        {preview ? (
          <img src={preview} alt="Aperçu de l'étiquette à analyser" className="h-[280px] w-full rounded-[1.25rem] bg-[#f7f8f6] object-contain" />
        ) : (
        ...
        >
          ...
          {isExtracting ? 'Extraction OCR...' : 'Extraire le texte'}
        </button>
      </div>
    </div>
  );
